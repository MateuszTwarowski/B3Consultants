...
namespace B3Consultants.Migrations
{
    ...
    [Migration("20220220202236_Init1")]
    partial class Init1
    {
            ...
            modelBuilder.Entity("B3Consultants.Entities.Consultant", b =>
                {
                    b.HasOne("B3Consultants.Entities.Availability", "Availability")
                        .WithOne("Consultant")
                        .HasForeignKey("B3Consultants.Entities.Consultant", "AvailabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("B3Consultants.Entities.Experience", "Experience")
                        .WithOne("Consultant")
                        .HasForeignKey("B3Consultants.Entities.Consultant", "ExperienceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
